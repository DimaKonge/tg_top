...
export function NftRankingTile({
  ...
  const isGift = nft.username.includes("Gift") || (nft as any).category === "gifts";
  ...
  if (variant === "compact") {
    return (
      <button
        type="button"
        onClick={() => onClick(nft)}
        className="group relative flex h-[104px] w-full flex-col justify-between overflow-hidden rounded-xl border border-white/10 bg-[#111720] p-2 text-left transition-all hover:border-[#3f8cff]/45 hover:bg-[#151e2b] active:scale-[0.98]"
      >
